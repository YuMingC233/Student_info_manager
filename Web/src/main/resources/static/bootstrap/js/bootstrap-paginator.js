"use strict";
var paginator = {
    init: function (elementId, totalPages, paramKey, SearchMode, NowPage, pageMaxCount = 5) {
        ...
        this.SearchMode = SearchMode;// 搜索模式，去除Page-link
    },
    show: function (currentPage) {
        ...
        if (this.SearchMode) {
            createHtml += '<a class="page-link" href="#" id="FirstPage">首页</a></li>';
        } else {
            createHtml += '<a class="page-link" href="' +
                url.replace(replaceVal, (this.paramKey + "=" + 1)) + '">首页</a></li>';
        }
        ...
        if (this.SearchMode) {
            createHtml += '<a class="page-link" href="#" id="PrevPage">上一页</a></li>';
        } else {
            createHtml += '<a class="page-link" href="' +
        ...
        for (var index = startPage; index <= endPage; index++) {
            ...
            if (this.SearchMode) {
                createHtml += '<a class="page-link" href="#">' + index + '</a></li>';
            } else {
                createHtml += '<a class="page-link" href="' +
        ...
        if (this.SearchMode) {
            createHtml += '<a class="page-link" href="#" id="NextPage">下一页</a></li>';
        } else {
            createHtml += '<a class="page-link" href="' +
        ...
        if (this.SearchMode) {
            createHtml += '<a class="page-link" href="#" id="EndPage">尾页</a></li>';
        } else {
            createHtml += '<a class="page-link" href="' +
                url.replace(replaceVal, (this.paramKey + "=" + this.totalPages)) + '">尾页</a></li>';
        }
